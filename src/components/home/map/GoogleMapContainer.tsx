...
export function GoogleMapContainer({ properties }: GoogleMapContainerProps) {
              ...
              >
                <div className="p-2 max-w-[300px]">
                  <div className="relative mb-2">
                    ...
                    />
                    {selectedProperty.has_live && (
                      <div className="absolute bottom-2 left-2">
                        {selectedProperty.is_live_now ? (
                          <Badge variant="destructive" className="bg-red-500">
                            <span className="mr-1 inline-block h-2 w-2 rounded-full bg-white animate-pulse" />
                            Live en cours
                          </Badge>
                        ) : selectedProperty.live_date && (
                          <Badge variant="secondary" className="bg-white/90 backdrop-blur-sm">
                            <Clock className="mr-1 h-4 w-4" />
                            {new Date(selectedProperty.live_date).toLocaleDateString("fr-FR", {
                              day: "numeric",
                              month: "short",
                              hour: "2-digit",
                              minute: "2-digit",
